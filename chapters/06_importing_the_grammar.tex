...
\input{chapters/06/01_the_simplexml_language}

\pagebreak

\input{chapters/06/02_parsing_the_grammar}

\input{chapters/06/03_grammar_representation}

\pagebreak

\input{chapters/06/04_generating_code_inside_mps}