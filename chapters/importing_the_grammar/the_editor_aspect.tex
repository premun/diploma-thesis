...
In figure \ref{fig:editor_adjustment}, we can see an editor adjustment of the \concept{Element{\_}1} concept, that can be done in just a few clicks, but finalizes the editor to its perfect form.
\\
