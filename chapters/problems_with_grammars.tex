...
Every statement in JavaScript needs to be either followed by a semicolon, new line, file end or end of block.
...
Because there are multiple options, our import plugin creates a placeholder in the end of every statement.
