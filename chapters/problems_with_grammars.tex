...
There is one big problem with grammar adjustment, that we would like to point out. The problem is, that it is very easy to change the grammar in a way, that will break the ANTLR parser generated out of it.
